    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          ...
          <Stack>
            <Typography
              variant="secondary h5"
              sx={{ paddingBottom: "16px", borderBottom: "1px dashed black" }}
            >
              Order Summary
            </Typography>
            ...
            <Container style={{ width: "70%", marginTop: "20px" }}>
              ...
              <Row>
                <Col>GST</Col>
                <Col style={{ textAlign: "end" }}>
                  &#8377;{Math.floor(slicedArray.map((a) => a.seats) * 4.36)}.00
                </Col>
              </Row>
              ...
              <Row className="mt-2">
                ...
                <Col style={{ textAlign: "end" }}>
                  <h6>Rs.{slicedArray.map((a) => a.grandTotal)}</h6>
                </Col>
              </Row>
            </Container>
          </Stack>
          ...
          <Stack>
            ...
            <ul className="mt-3" style={{ listStyleType: "none" }}>
              ...
              <li>
                The 3D glasses will be available at the cinema for 3D films and
                must be returned before you exit the premises. 3D Glasses are
                chargeable (refundable/ non-refundable) as per individual cinema
                policies.
              </li>
              <li>
                Items like laptop, cameras,knifes, lighter,match box,
                cigarettes, firearms and all types of inflammable objects are
                strictly prohibited.Items like carrybags eatables, helmets,
                handbags are not allowed inside the theaters are strictly
                prohibited. Kindly deposit at the baggage counter ofmall/
                cinema.
              </li>
            </ul>
          </Stack>
